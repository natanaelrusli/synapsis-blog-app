...
import { Button, Col, Input, Pagination, Row, Select, Skeleton, Spin } from 'antd';
...
const PostsGrid: React.FC = () => {
  ...
  const { data: posts, isLoading, error, refetch } = useQuery({
    ...
    queryFn: () => fetchPosts(currentPage, DATA_PER_PAGE),
    placeholderData: keepPreviousData
  });

  const filterPosts = useCallback((filterText: string) => {
    if (posts) {
  ...
  const debouncedFilter = useCallback((filterText: string) => {
